...
| `/career-mode` | `src/data/pages/guide-pages.ts` | Guide | EA SPORTS FC 27 Career Mode deep dive | Plan a Career save using TransferRoom, Dynamic OVR, six Growth Profiles, Manager Live Creator Challenges, Career ICONs, Pre-Order Challenges, Player Career Rivalries | Player Ratings | Hub (Career) | Last reviewed 2026-09-22; cross-links to /player-ratings, /ultimate-team, /club-membership. |
| `/ultimate-team` | `src/data/pages/guide-pages.ts` | Guide | EA SPORTS FC 27 Ultimate Team FUT systems | Plan a FUT launch path with Holographic Items, Streamlined SBCs, Gallery, Hall of FUT, PlayStyle+ cap, ICON baseline, Post-Match Rewards, Champions CQP, TOTW vote, Rivals Division 1 rewards, pack rarity rename | Player Ratings | Hub (FUT) | Last reviewed 2026-09-22; cross-links to /player-ratings, /club-membership. |
...
| `/the-grounds` | `src/data/pages/guide-pages.ts` | Guide | EA SPORTS FC 27 The Grounds mode | Start The Grounds social hub: districts, Kickabouts, Rush 5v5, House Rules, mentors, Archetype / Mastery / Amp, Signature Amps (Mbappe Tier 3), free Archetype reset, Season 1 Live Events | New Features / Clubs | Hub (The Grounds) | Last reviewed 2026-09-22; cross-links to /new-features, /clubs, /club-membership. |
| `/clubs` | `src/data/pages/guide-pages.ts` | Guide | EA SPORTS FC 27 Clubs Pro Clubs | Online co-op 11v11 cross-platform clubs | Home | Hub (Clubs) | Last reviewed 2026-09-17. |
...
| `/editions` | `src/data/pages/guide-pages.ts` | Guide | EA SPORTS FC 27 editions | Standard vs Ultimate price, early access, Premium Pass, FC Points | System requirements | Hub (Editions) | Last reviewed 2026-09-22; cross-links to /club-membership. |
